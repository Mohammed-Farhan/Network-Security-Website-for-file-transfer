...
<body>
	<div  style=" background-color:#474a4a; padding-top:10px; padding-left: 0px;">
		<div id="header" class="container">
			...
			<div id="menu">
				<ul>
					...
					<li><a href="apfiles.jsp" accesskey="3" title="">Requested
							Files</a></li>
					...
					<table style="width: 1150px; padding-left: 150px;">
						<thead>
							<tr>
								...
								<th style="color: white;">Search</th>
							</tr>
						</thead>
						<tbody>
							<tr>
								<td><input type="text" name="sub" /></td>
								<td><input type="submit" value="Search" class="actions" /></td>
							</tr>
						</tbody>
					</table>
				</form>
