		...
		<div id="header" class="container">
			...
			<div id="menu">
				<ul>
					...
					<li class="active"><a href="akey.jsp" accesskey="4" title="">Keys</a></li>
		...
		<div id="banner" class="container">
			<div class="title">
				...
				<table style="width: 850px; padding-left: 250px;"
					...
					<thead>
						<tr>
							<th style="font-size:16px;color: white;">FID</th>
							<th style="font-size:16px;color: white;">Owner</th>
							<th style="font-size:16px;color: white;">User</th>
							<th style="font-size:16px;color: white;">Approve</th>
						</tr>
					</thead>
					<%
						while(itr.hasNext()){
