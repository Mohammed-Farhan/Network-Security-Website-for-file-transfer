...
<div id="header-wrapper" style="padding-top: 10px; padding-left: 0px;">
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				...
				<li class="active"><a href="user.jsp" accesskey="3" title="">User</a></li>
			</ul>
		</div>
	</div>
	<div id="banner" class="container" style=" padding-top: 30px; padding-bottom: 150px;">
		...
		<h2 >Login</h2>
			<form action="User" method="post" style="text-align: left;">
		...
		<form action="UserReg" method="post">
			...
			<tr><td>Mobile</td><td><input type="text" name="mob"  style="width: 350px;"/> </td></tr>
