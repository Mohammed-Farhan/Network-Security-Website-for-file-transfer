	...
	<div style="background-color:#5F6A6A; padding-top: 10px; padding-left: 0px;">
		...
		<div id="banner" class="container" style="padding-top: 100px;">
			<div class="title">
				...
				%>
				<table style="width: 1050px; padding-left: 150px;">
					<tr>
						<th style="font-size:16px;color: white;">FID</th>
						<th style="font-size:16px;color: white;">Owner</th>
						<th style="font-size:16px;color: white;">UserId</th>
						<th style="font-size:16px;color: white;">IP</th>
						<th style="font-size:16px; color: white;">Date</th>
					</tr>
					<%
						while(itr.hasNext()){
					%>
				...
				<a href="agraphs.jsp">Attack Graphs</a>
			</div>
		</div>
	</div>
