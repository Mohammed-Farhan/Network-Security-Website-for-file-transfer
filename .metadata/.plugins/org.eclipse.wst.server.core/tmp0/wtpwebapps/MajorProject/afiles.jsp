		...
		<div id="header" class="container">
			...
			<div id="menu">
				<ul>
					...
					<li class="active"><a href="afiles.jsp" accesskey="4" title="">Files</a></li>
		...
		<div id="banner" class="container">
			<div class="title">
				...
				<table style=" padding-left:70px">
						<tr>
							<th style=" font-size:16px;color: white; width: 50px;">FID</th>
							<th style="font-size:16px;color: white; width: 60px;">Owner</th>
							<th style="font-size:16px;color: white; width: 60px;">File</th>
							<th style="font-size:16px;color: white; width: 60px;">Key1</th>
							<th style="font-size:16px;color: white; width: 60px;">Key2</th>
							<th style="font-size:16px;color: white; width: 60px;">Key3</th>
							<th style="font-size:16px;color: white; width: 60px;">Key4</th>
							<th style="font-size:16px;color: white;">Update</th>
						</tr>
					<%
						while(itr.hasNext()){
							String fid = itr.next();
