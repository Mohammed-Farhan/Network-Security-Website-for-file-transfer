		...
		<div id="banner" class="container">
			<div class="title">
				...
				<table style=" padding-left:20px">
						<tr>
							<th style=" font-size:18px;text-align:center;color: white; width: 50px;">FID</th>
							<th style="font-size:18px;text-align:center;color: white; width: 60px;">Owner</th>
							<th style="font-size:18px;text-align:center;color: white; width: 70px;">File</th>
							<th style="font-size:18px;text-align:center;color: white; width: 60px;">Key1</th>
							<th style="font-size:18px;text-align:center;color: white; width: 60px;">Key2</th>
							<th style="font-size:18px;text-align:center;color: white; width: 60px;">Key3</th>
							<th style="font-size:18px;text-align:center;color: white; width: 60px;">Key4</th>
							<th style="font-size:18px;text-align:center;color: white;">Update</th>
						</tr>
					<%
						while(itr.hasNext()){
							String fid = itr.next();
					...
					<tr>
						...
						<td style="width: 70px;"><%=itr.next()%></td>
						<td style="width: 60px;"><%=itr.next()%></td>
						<td style="width: 60px;"><%=itr.next()%></td>
						<td style="width: 60px;"><%=itr.next()%></td>
						<td style="width: 60px;"><%=itr.next()%></td>
