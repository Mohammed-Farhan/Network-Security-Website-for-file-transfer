	...
	<div style=" background-color:#5F6A6A;padding-top: 10px; padding-left: 0px;">
		<div id="header" class="container">
			...
			<div id="menu">
				<ul>
					...
					<li class="active"><a href="search.jsp" accesskey="2" title="">Search</a></li>
					<li><a href="apfiles.jsp" accesskey="3" title="">Requested Files</a></li>
		...
		<div id="banner" class="container" style="padding-top: 100px;">
			<div class="title">
				...
				%>
				<table style="width: 1150px; padding-left: 150px;">
					<thead>
						<tr>
							<th style="color: white;text-align:center;font-size:18px">FID</th>
							<th style="color: white;text-align:center;font-size:18px">UserID</th>
							<th style="color: white;text-align:center;font-size:18px">FileName</th>
							<th style="color: white;text-align:center;font-size:18px">Download</th>
							<th style="color: white;text-align:center;font-size:18px">Key Request</th>
						</tr>
					</thead>
					<%
						while(itr.hasNext()){
