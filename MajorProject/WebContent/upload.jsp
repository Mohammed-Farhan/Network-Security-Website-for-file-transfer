...
<div  style="background-color:#5F6A6A; padding-top: 10px; padding-left: 0px;">
	...
	<div id="banner" class="container" style=" padding-top: 80px; padding-bottom: 150px;">
		...
		<h2>Upload</h2>
			...
			<thead><tr><th style="font-size:18px;text-align:center;color: white;">File Name</th><th style="font-size:18px;text-align:center;color: white;">Description</th>
			<th style="font-size:18px;text-align:center; color: white;">File</th>
			<th style="font-size:18px;text-align:center; color: white;">Upload</th></tr></thead>
