			...
			<div class="title">
				...
				<form action="Down" method="post">
					<table style="width: 1200px; padding-left: 50px;">
						<thead>
							<tr>
								<th style="font-size:18px;text-align:center;color: white;">FID</th>
								<th style="font-size:18px;text-align:center;color: white;">Key1</th>
								<th style="font-size:18px;text-align:center;color: white;">Key2</th>
								<th style="font-size:18px;text-align:center;color: white;">Key3</th>
								<th style="font-size:18px;text-align:center;color: white;">Key4</th>
								<th style="font-size:18px;text-align:center;color: white;">Download</th>
							</tr>
						</thead>
							<tr>
								...
								<td><input type="password" name="key3" style="width: 150px;" /></td>
								<td><input type="password" name="key4" style="width: 150px;" /></td>
