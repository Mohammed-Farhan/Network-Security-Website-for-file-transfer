				...
				<table style="width: 850px; padding-left: 250px;"
					...
					<thead>
						<tr>
							...
							<th style="font-size:18px;text-align:center;color: white;">Owner</th>
							<th style="font-size:18px;text-align:center;color: white;">User</th>
							<th style="font-size:18px;text-align:center;color: white;">Approve</th>
						</tr>
					</thead>
					<%
						while(itr.hasNext()){
