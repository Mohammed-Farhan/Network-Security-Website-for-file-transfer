...
<div  id="header-wrapper" style="padding-top:10px; padding-left:0px;">
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				...
				<li  class="active"><a href="admin.jsp" accesskey="2" title="">Admin</a></li>
				<li><a href="owner.jsp" accesskey="3" title="">Data Owner</a></li>
				<li><a href="user.jsp" accesskey="3" title="">User</a></li>
			</ul>
		</div>
	</div>
	<div id="banner" class="container" style=" padding-top: 80px; padding-bottom: 150px;">
		...
		<h2>Login</h2>
			...
			<table class=" fa-lg table-wrapper alt" style="width: 650px; padding-left: 250px;">
			<tr><td>UserId</td><td><input type="text" name="uid" style="width: 450px;"/> </td></tr>
			<tr><td>Password</td><td><input type="password" name="pwd" style="width: 450px;"/> </td></tr>
...
binary intermediate sequence z1 based on a high-dimensional binary invertible matrix generated by the concept of NC. The main purpose of this step is to extend the key space of the algorithm, so as to resist the exhaustive attack.  </p>
		...
		<div class="boxC"  >
			...
			<a href="#" class="button button-alt" style = "width:350px;margin-top:4px; padding-left:4px" >Outer-Layer Encryption Embedding NC</a>
		</div>
