		...
		<div id="header" class="container">
			...
			<div id="menu">
				<ul>
					...
					<li><a href="upload.jsp" accesskey="2" title="">Upload</a></li>
					<li class="active"><a href="okey.jsp" accesskey="3" title="">Request</a></li>
				...
				<table style="width: 850px; padding-left: 250px;">
					<thead>
						<tr>
							...
							<th style="font-size:18px;text-align:center;color: white;">UserID</th>
							<th style="font-size:18px;text-align:center;color: white;">Status</th>
							<th style="font-size:18px;text-align:center;color: white;">Send</th>
						</tr>
					</thead>
					<%
						while(itr.hasNext()){
